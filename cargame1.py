"""
@creater: vibha shukla
@email: vibhashukla2607@gmail.com
...
class CarRacing:
    ...
    def initialize(self):
        ...
        self.carImg = pygame.image.load('.\\img\\yc.png')
        self.car_x_coordinate = (self.display_width * 0.45)
        self.car_y_coordinate = (self.display_height * 0.8)
        self.car_width = 49

        # enemy_car
        self.enemy_car = pygame.image.load('.\\img\\rc.png')
        ...
        # Background
        self.bgImg = pygame.image.load(".\\img\\bg2.jpg")
    ...
    def display_credit(self):
        ...
        text = font.render("vibha shukla", True, self.white)
        self.gameDisplay.blit(text, (600, 540))
        text = font.render("vibhashukla2607@gmail.com", True, self.white)
